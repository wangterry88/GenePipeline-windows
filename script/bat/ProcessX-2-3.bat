...
.\R\R-4.1.1\bin\Rscript.exe .\script\Rscript\2.GWAS\Step2.GWAS_plot.R %gwas_filename% %outname_plot% %outname_sigt% %project%
...
.\R\R-4.1.1\bin\Rscript.exe .\script\Rscript\2.GWAS\Step3.GWAS_Gene_plot.R .\Result\%project%\GWAS\%outname_sigt%.txt.annot %outname_sigt% %project%
